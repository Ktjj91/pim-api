...
class Product
{
    ...
    /**
     * @var Collection<int, Attribut>
     */
    #[ORM\ManyToMany(targetEntity: Attribut::class, inversedBy: 'products')]
    ...
    public function addAttribut(Attribut $attribut): static
    {
    ...
    public function removeAttribut(Attribut $attribut): static
    {
